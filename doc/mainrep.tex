...
%                         Title Page
%*******************************************************************
\title{Discrete Element Method and Smoothed Particle Hydrodynamics Coupling}
\author{Dinesh A}
...
\reporttype{An Annual Progress Seminar Report}
% \reporttype{A Thesis}
...
%                         Dedication Page
%*******************************************************************
\dedication[Dedicated to Pawan \ldots]
%\addintoc{Dedication}
...
\include{sph/sph_intro}
\include{dem/dem_intro}
